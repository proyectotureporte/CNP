...
- 2026-06-11 · QA: `/api/web-form` no está exenta en middleware (¿landing rota?) y `/api/whatsapp/leads*` + `/crm/mensajes` están exentas (¿abiertas sin auth?) — verificación en curso
